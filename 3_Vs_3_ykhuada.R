        ...
        for (q in (p+1):26) {
          ...
          for (r in (q+1):27) {
            ...
            if(y>z & (y/z) >= 4 & prdm1_b<0.05 & prdm1_a>0.58 ){
              ...
              c<-rbind(c,b)
              write.table(mycounts,file = paste0("mycounts_YKHUADA_3vs3",j,k,l,p,q,r,y,z,prdm1_a,".txt"),sep = "\t")
              write.table(res,file = paste0("mycounts_YKHUADA_Diff_3vs3",j,k,l,p,q,r,y,z,prdm1_a,".txt"),sep = "\t")
            }
