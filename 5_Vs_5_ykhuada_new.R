        ...
        for (q in (p+1):24) {
          ...
          for (r in (q+1):25) {
            ...
            if(y>z & (y/z) >= 4 & prdm1_b<0.05 & prdm1_a>0.58 & is.na(prdm1_b) == FALSE & y>=100){
              ...
              c<-rbind(c,b)
              write.table(mycounts,file = paste0("mycounts_YKHUADA_5vs5_new",j,k,l,m,n,p,q,r,s,t,y,z,prdm1_a,".txt"),sep = "\t")
              write.table(res,file = paste0("mycounts_YKHUADA_Diff_5vs5_new",j,k,l,m,n,p,q,r,s,t,y,z,prdm1_a,".txt"),sep = "\t")
            }
